...
HipacheHosts.prototype.addContainerPorts = function (container, cb) {
  ...
  containerExpiryTime = new Date(containerStartTime.getTime() + (configs.container.defaultExpiry * 60 * 1000));
...
HipacheHosts.prototype.extendContainerLife = function (container, cb) {
  ...
  var containerStartTime = new Date();
  containerNewExpiryTime = new Date(containerStartTime.getTime() + (configs.container.defaultExpiryExtension * 60 * 1000));
