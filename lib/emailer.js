...
exports.sendSpamReport = function(appUrl, reporter, cb) {
  ...
  var opts = {
    ...
    subject: 'Spam report at ' + configs.domain,
    html: '<p>User <a href="' + userUrl + '">' + reporter.lower_username + '</a> ' + 'has reported a spam for this runnable: <a href="' + appFullUrl + '">' + appFullUrl + '</a> </p>',
    text: 'User ' + userUrl + ' has reported a spam for this runnable:: ' + appFullUrl
  };
  this.sendEmail(opts, cb);
}
