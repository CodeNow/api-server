...
exports.sendVerificationMail = function (user, cb) {
  userVerificationLink = 'http://' + configs.domain + '/user/verify/' + user.verification_token;
  var opts = {
    to: user.email,
    subject: 'Activate you brand new account at code.runnable.com',
    text: 'Please copy the following link and open in your browser to activate your account: ' + userVerificationLink,
    html: "Please click the following link to activate your account: <a href='" + userVerificationLink + "'>" + userVerificationLink + "</a>",
  };
  this.sendEmail(opts, cb);
};
