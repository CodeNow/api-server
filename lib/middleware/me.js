...
var me = module.exports = createMongooseMiddleware(User, {
  ...
  changeMail: function (verificationData) {
    return series(
      body.require('username', 'email_change_token'),
      body.pick('username', 'email_change_token'),
      this.findOne({
        username: 'body.username',
  ...
  setpass: function (verificationData) {
    return series(
      body.require('username', 'new_pass', 'pass_reset_token'),
      body.pick('username', 'new_pass', 'pass_reset_token'),
      this.findOne({
        username: 'body.username',
