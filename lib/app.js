...
function sendIf400Error (err, req, res, next) {
  ...
  console.error("ERROR sendIf400Error", err, err.stack, res.code, err.msg);
...
function mongooseErrorHandler (err, req, res, next) {
  console.error("ERROR mongooseErrorHandler", err, err.stack, res.code, err.msg);
...
function errorCaster (err, req, res, next) {
  console.error("ERROR errorCaster", err, err.stack, res.code, err.msg);
...
function errorMiddleware (err, req, res, next) {
  console.error("ERROR errorMiddleware", err, err.stack, res.code, err.msg);
